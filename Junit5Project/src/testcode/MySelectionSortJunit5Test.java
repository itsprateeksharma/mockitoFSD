...
/*
 * Repeated tests are run with the @RepeatedTest annotation. We specify 
 * the total number of repetitions desired.
 */
class MySelectionSortJunit5Test {
	
	//private MySelectionSort Ms;
	...
	@RepeatedTest(value=40,name="#{displayName} {currentRepitition}/{totalRepetitions}")
